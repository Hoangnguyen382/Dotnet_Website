...
namespace Layout_Admin.Service
{
    public class UserService
    {
        ...
        public UserService(HttpClient http, ILocalStorageService localStorage, AuthHttpClientFactory factory)
        {
            _http = http;
        ...
        // ✅ Cập nhật thông tin người dùng (có thể là self hoặc Admin cập nhật người khác)
